...
angular.module('xeditable').factory('editableController',
  ...
  function EditableController($scope, $attrs, $element, $parse, editableThemes, editableIcons, editableOptions, $rootScope, $compile, $q) {
    ...
    self.single = true;
    self.error = '';
    self.theme = editableThemes['bs3'];
    //self.theme =  editableThemes[editableOptions.theme] || editableThemes['default'];
    self.parent = {};

    //will be undefined if icon_set is default and theme is default
    self.icon_set = editableOptions.icon_set === 'default' ? editableIcons.defaults[editableOptions.theme] : editableIcons.external[editableOptions.icon_set];
...
angular.module('xeditable').factory('editableThemes', function() {
  var themes = {
    ...
    'default': {
      ...
      submitTpl:    '<button type="submit" class="btn btn-primary">保存</button>',
      cancelTpl:    '<button type="button" class="btn btn-warning" ng-click="$form.$cancel()">キャンセル</button>'
    },
    ...
    'bs3': {
      ...
      errorTpl:    '<div class="editable-error help-block" ng-show="$error" ng-bind="$error"></div>',
      buttonsTpl:  '<span class="editable-buttons"></span>',
      submitTpl:   '<button type="submit" class="btn btn-primary"><span>保存</span></button>',
